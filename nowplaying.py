...
# Here, we're telling Python that when we say 'player' we mean clementine. Later we'll expand this to check for different players.
...
#print('Now playing:',
#	(metadata[u'xesam:title']),
#	 'performed by',
##	 'from',
#	 (metadata[u'xesam:album']),
#).encode('utf-8')
